...
<div class="login-clean">
    <form method="post" action="update">
        ...
        <div class="form-group blocked"><input class="form-control" type="text" name="id" disabled="" value="<?php echo !empty($customer["id"]) ? $customer["id"] : ''; ?>"></div>
        <div class="form-group blocked"><input class="form-control" type="text" name="username" disabled="" value="<?php echo !empty($customer["username"]) ? $customer["username"] : ''; ?>"></div>
